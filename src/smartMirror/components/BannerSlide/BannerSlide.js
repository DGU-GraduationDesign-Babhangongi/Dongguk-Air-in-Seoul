...
const Datas = [
  {
    ...
    name: '중앙동아리 CAPS',
    image: 'Caps.png',
    content: 'CAPS는 프로그래밍에 관심이 있는 사람들이 모여 학술 활동과 친목 행사를 진행합니다!\n 전공, 지식 상관 없이 관심만 있으면 환영입니다 :)',
  },
  {
    id: 2,
    name: '대학연합동아리 쌍투스코러스',
    image: 'TwinChorus.jpg',
    content: "우리들은 노래로 사랑을 심어요!\n 쌍투스코러스는 노래와 사람을 사랑하는 사람들이 모인 \"대학 연합 합창 뮤지컬 동아리\"입니다.",
  },
  {
    id: 3,
    name: '중앙동아리 동굴탐험연구회',
    image: 'Caving.jpg',
    content: "인생에서 쉽게 경험하기 힘든 동굴탐험, 암벽등반, 스쿠버다이빙, 스키캠프, 해외여행 등 다양한 활동을 해보고 싶다면 동굴탐험연구회로 오세요!",
  },
  {
    id: 4,
    name: 'AI융합대학 소모임 한소리',
    image: 'hansori.jpg',
    content: "한소리는 AI융합대학 풍물놀이 동아리입니다.\n 매년 여러 공연과 한소리 정기공연을 진행하고 있으며 풍물에 관심이 있으신 분들은 누구나 가입 가능합니다.",
  },
  {
    id: 5,
    name: '중앙 국악동아리 다락',
    image: 'darock.jpg',
    content: "다락도 rock이다!\n대학생활의 낭만을 국악으로 채워보시는 건 어떨까요?\n인스타그램 : @dongguk_darock\n(신입부원 상시모집)",
  },
  {
    id: 6,
    name: '동아리 홍보 신청하기',
    image: 'qr.png',
    content: "동아리 및 다양한 홍보를 원하시면, 아래 QR 코드를 이용해 구글폼을 작성해 주세요!\n 작성해 주신 내용은 해당 위치에 게시됩니다.",
  },
  {
    id: 7,
    name: 'AI융합대학 소모임 한소리',
    image: 'hansoriLogo.png',
    content: "한소리는 AI융합대학 풍물놀이 동아리입니다.\n 매년 여러 공연과 한소리 정기공연을 진행하고 있으며 풍물에 관심이 있으신 분들은 누구나 가입 가능합니다.",
  },
];
...
const BannerSlide = () => {
  ...
  // 터치 종료 지점 비교하여 슬라이드 전환
  const handleTouchEnd = (e) => {
    const touchEnd = e.changedTouches[0].clientX;
    const swipeThreshold = 75; // 밀기 임계값
  ...
  const getImage = (imageName) => {
    try {
      return imageName ? require(`../../../assets/images/smartmirror/Promotion/${imageName}`) : null;
    } catch (error) {
    ...
    >
      <div style={{ width: '100%' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 0.2fr 5fr' }}>
          <img
            src={getImage(slides[currentIndex]?.image)} // 이미지 경로 처리
